...
<head>
    ...
    <![endif]-->
    <link rel="stylesheet" href="/ThinkCMFX2/public/simpleboot/themes/<?php echo C('SP_ADMIN_STYLE');?>/simplebootadminindex.min.css?">
    <!--[if lte IE 8]>
    <link rel="stylesheet" href="/ThinkCMFX2/public/simpleboot/css/simplebootadminindex-ie.css?"/>
    <![endif]-->
    <style>
    ...
    <div class="navbar-inner">
        <div class="container-fluid">
            <a href="<?php echo U('index/index');?>" class="brand">
                <small>
                    <img src="/ThinkCMFX2/admin/themes/simplebootx/Public/assets/images/logo-18.png">
            ...
            <div class="pull-left nav_shortcuts">
                ...
                <a class="btn btn-small btn-warning" href="/ThinkCMFX2/" title="<?php echo L('WEBSITE_HOME_PAGE');?>" target="_blank">
                ...
                <li class="light-blue">
                    <a data-toggle="dropdown" href="#" class="dropdown-toggle">
                        <?php if($admin['avatar']): ?><img class="nav-user-photo" width="30" height="30" src="<?php echo sp_get_user_avatar_url($admin['avatar']);?>" alt="<?php echo ($admin["user_login"]); ?>">
                            <?php else: ?>
                            <img class="nav-user-photo" width="30" height="30" src="/ThinkCMFX2/admin/themes/simplebootx/Public/assets/images/logo-18.png" alt="<?php echo ($admin["user_login"]); ?>"><?php endif; ?>
                    ...
                    <ul class="user-menu pull-right dropdown-menu dropdown-yellow dropdown-caret dropdown-closer">
                        <?php if(sp_auth_check(sp_get_current_admin_id(),'admin/setting/site')): ?><li>
                                <a href="javascript:openapp('<?php echo U('setting/site');?>','index_site','<?php echo L('ADMIN_SETTING_SITE');?>');"><i class="fa fa-cog"></i>
                                    <?php echo L('ADMIN_SETTING_SITE');?></a></li><?php endif; ?>
                        <?php if(sp_auth_check(sp_get_current_admin_id(),'admin/user/userinfo')): ?><li>
                                <a href="javascript:openapp('<?php echo U('user/userinfo');?>','index_userinfo','<?php echo L('ADMIN_USER_USERINFO');?>');"><i class="fa fa-user"></i>
                                    <?php echo L('ADMIN_USER_USERINFO');?></a></li><?php endif; ?>
...
<script src="/ThinkCMFX2/admin/themes/simplebootx/Public/assets/js/index.js"></script>
</body>
</html>